...
The apex of your trajectory just barely reaches the surface of a large
island floating in the sky. You gently land in a fluffy pile of leaves.
...
for the lack of snow. He'll be happy to explain the situation,
...
export const d2p1 = (input: string[]) => {
