...
a look of surprise. "Sorry, I wasn't expecting anyone!
The gondola lift isn't working right now; it'll still be
a while before I can fix it." You offer to help.
...
export const d3p2 = (input: string[]) => {
  let sum: number = 0;
